        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="Radio_role" CssClass="col-md-2 control-label">Login As:</asp:Label>
                        <div class="col-md-10">
                            <asp:RadioButtonList ID="Radio_role" runat="server">
